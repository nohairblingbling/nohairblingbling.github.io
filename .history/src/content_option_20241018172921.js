...
const meta = {
  title: "Yuzhuo Jia",
  description: "I'm Yuzhuo Jia [在这里添加您的简短描述]",
};
...
const dataabout = {
  title: "Research Interests123123",
  aboutme:
    "My research is primarily focused on the development of AI tools for communities, specifically exploring the implementation of LLM agents with model-level interactions or user-centered evaluations. I aim to create tools that embrace social consciousness, beyond considerations of model precision and performance.",
};
const worktimeline = [
  {
...
const researchexperience = [
  {
    ...
    period: "June 2023 - ",
    description:
      "Developed a LLM Teachable Agent (Algobo) for Programming Education. Developed prompting techniques for Knowledge State Configuration and conducted LLM Agent Evaluation on different knowledge states. Submitted to CHI 2024",
  },
  {
  ...
  },
  {
    ...
    period: "June 2023 - ",
    description:
      "Perceived Harm Research through an extension that collects user viewed comments on Reddit. Full Stack Development of website that processes user comments, labels toxicity scores and generates survey pairs. Parallel processing of comments, data mangagement and storage, web security. ",
  },
];
...
const dataportfolio = [
  ...
  },
  {
    img: "cs224s",
    title:
      "Beyond Scale: Analyzing ASR Model Performance in Code-Switching Data",
  ...
  },
  {
    ...
    conference:
      "2024 19th ACM/IEEE International Conference on Human-Computer Interaction (CHI)",
  ...
  },
  {
    img: "multi",
    title:
      "MultiSum: A Large Dataset for Multimodal Video Temporal Segmentation and Summarization",
    authors:
      "Jielin Qiu, Claire Jin, Seong hee Lee, Ding Zhao, 2023 18th ACM/IEEE International Conference on Machine Learning (ICML), 2023",
...
const projectportfolio = [
  {
    ...
    description:
      "Backend Development of LLM Based Book Recommendation API, User Book Club Groups API - Typescript, Nestjs, Swagger",
  ...
  },
  {
    ...
    description:
      "Fullstack Development of Reddit Survey through using a chrome extension to scrape user comments, analyze scores through Perspective and Generative survey questions. Parallel Processing, Serverside development Django",
  ...
  },
  {
    ...
    description:
      "Full Stack development of Non-verbal AI Interaction prototype in Mercedes Benz Cars using Cochl Socket API",
    github: "https://github.com/shljessie/MBUX",
  },
  {
    title: "MyCourseIndex - Cornell Data Science",
    description:
      "an essential search engine for Cornell students and their courses with the initial goal to improve the Piazza search user experience. This search gathers all information from Piazza posts to Textbook and Notes Resources and returns valid results for the student to utilize",
  ...
  // },
  {
    ...
    description:
      "As of Jun 2020, there are only 17 survivors of the Japanese military comfort women. We are initiating the '영원한 증언 Eternal Testimony' project, a novel way to preserve our history for all perpetuity in a vivid and memorable way.",
    website:
      "https://www.creative-computing.org/post/eternal-testimony-2018-2020",
  },
  {
    title:
      "The Last 100 meter Problem: Passenger Interaction in Autonomous Vehicles",
    description:
      "A Gestural Interaction for Passenger Interaction in Autonomous Vehicles",
