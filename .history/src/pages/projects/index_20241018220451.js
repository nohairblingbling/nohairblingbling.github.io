              ...
              <div key={i} className="researchBox">
                ...
                <div className="description">
                  ...
                  <div>
                    ...
                    {data.website && 
                      <><a className="d" href={data.website}>website</a> | </>}
                    {data.paper && 
                      <a className="d" href={data.paper}>paper</a>}
                    {data.project && 
                      <><a className="d" href={data.project}>Project</a></>}
                    {data.code && 
                      <><span className="d">{data.code}</span></>}
                  </div>
                </div>
              </div>
            );
