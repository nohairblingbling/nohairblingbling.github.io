...
const projectportfolio = [
  {
    ...
    description:
      "Developed a Next.js web app utilizing AI for academic paper review with PDF upload, customizable parameters, multilingual support, and a responsive, animated UI built with React, TypeScript, Tailwind CSS, and integrated with OpenAI/Claude’s API.",
